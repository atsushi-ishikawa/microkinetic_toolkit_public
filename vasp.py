...
#   def __init__(self, restart=None,
    def __init__(self, label=None, restart=None,
...
#
        if (self.int_params['images'] is not None):
            self.contcar = '01/CONTCAR'
            self.outcar  = '01/OUTCAR'
        else:
            self.contcar = 'CONTCAR'
            self.outcar  = 'OUTCAR'
        atoms_sorted = ase.io.read(self.contcar, format='vasp')
#
